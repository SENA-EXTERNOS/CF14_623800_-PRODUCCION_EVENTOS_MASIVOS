  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Modelo de gestión del riesgo 
        ...
        PasosA.color-acento-contenido.mb-5(tipo="n")
          ...
          .row.justify-content-around.align-items-center.mt-5.mb-5
            ...
            .col-lg
              ...
              p #[b Evaluar el nivel de riesgo:] usando la metodología de riesgo por colores o su adaptación, teniendo en cuenta las variables de amenazas y vulnerabilidad.
          ...
          .row.justify-content-around.align-items-center.mt-5.mb-5
            ...
            .col-auto
              figure(data-aos="zoom-in")
                img(src='@/assets/curso/temas/tema2/img4.png', alt='').img125
    ...
    .row.justify-content-center.mb-5
      .col-lg-6
        LineaTiempoD.color-primario
          ...
          p(numero="11" titulo="Coordinador de movilidad y tránsito") Debe ser el enlace entre el evento y la Secretaría de Movilidad o tránsito, solo aplica en aquellos casos en los que la actividad a desarrollar implique cierres viales o compromiso de áreas de movilidad vehicular, en ese caso se deberá designar y gestionar el cumplimiento del plan.
    ...
    .row.justify-content-around.align-items-center.mt-5.mb-5
      ...
      .col-lg-7
        p Para intervenir los factores de riesgos por amenazas se tienen en cuenta dos fases, la mitigación y la preparación.

        p A continuación se describe cada una de ellas:

        ol.lista-ol--cuadro
          li 
            .lista-ol--cuadro__vineta
              span 1
            p.mb-0 #[b Mitigación:] para poder intervenir los factores de riesgo se debe hacer identificación de las amenazas, monitoreo de las condiciones ambientales, de infraestructura y reducir la vulnerabilidad a través de la consecución de los recursos, sistemas alternativos de atención para emergencias y contar con el personal calificado y entrenado en primeros auxilios, y evacuación e incendio.
    ...
    .row
      p Para la elaboración del plan de gestión del riesgo se deben tener en cuenta los siguientes pasos:

    
    TabsC.color-primario
      .py-3.py-md-4(titulo="Identificación de amenazas").bgr-tarjeta-4
        .row.justify-content-around.align-items-center.mt-5.mb-5
          .col-md-6
            figure
    ...
    .row.mt-5
      ...
      .col-lg-6
        ...
        p La ficha técnica para el plan de gestión de riesgo contempla:
        ...
        ol.lista-ol--cuadro
          ...
          li 
            .lista-ol--cuadro__vineta
              span 2
            | Condiciones externas al desarrollo del evento.

          li 
            .lista-ol--cuadro__vineta
              span 3
            | Roles y estructura para el desarrollo de la actividad.
          ...
          li 
            .lista-ol--cuadro__vineta
              span 5
            | Procedimiento de monitoreo de gestión del riesgo.

          li 
            .lista-ol--cuadro__vineta
              span 6
            | Procedimiento de notificación o códigos de alarma a utilizar.
          
          li 
            .lista-ol--cuadro__vineta
              span 7
            | Reducción del riesgo: intervención que se le realiza al lugar, medidas de control y mecanismos de protección financiera (pólizas, seguros).

          li 
            .lista-ol--cuadro__vineta
              span 8
            | Manejo de desastres: organigrama para la atención de emergencias, roles y responsabilidades asignadas para el evento.
    ...
    .row
      p Anexo a la gestión del riesgo se elaboran los planes operativos normalizados, que son aquellos instrumentos que nos permiten definir los recursos necesarios para atender una emergencia y las condiciones en las que se activan, de acuerdo con lo estipulado por el ‘Manual para la elaboración de planes de emergencia y contingencias en aglomeraciones de público ocasionales’ (Fondo de prevención y atención de emergencias FOPAE- 2016), que se relacionan a continuación:
    ...
    .cajon.bgr-tarjeta-1.p-4.mt-5
      .row
        .col-12
          p Para entender estos planes por favor descargar y estudiar el Anexo 4_Fichas técnicas planes,  en donde encontrará su respectiva explicación. La teoría allí contenida tiene los requisitos mínimos para la elaboración de cada plan, pero el desarrollo de estas debe ser adaptada a las características de cada evento. 
